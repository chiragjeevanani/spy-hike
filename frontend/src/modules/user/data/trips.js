...
export const HIKING_TRIPS = [
  {
    ...
    pickupPoints: ['Manali', 'Delhi', 'Chandigarh'],
    departureDates: ['2026-07-20', '2026-08-05', '2026-08-20', '2026-09-02'],
    rating: 4.9,
    reviewsCount: 142,
    price: 349,
  ...
  },
  {
    ...
    pickupPoints: ['Kasol', 'Bhuntar'],
    departureDates: ['2026-07-25', '2026-08-10'],
    rating: 4.6,
    reviewsCount: 58,
    price: 299,
